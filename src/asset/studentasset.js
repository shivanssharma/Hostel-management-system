...
function StudentAsset() {
    ...
    const handleBookAsset = () => {
        ...
        axios
            .post(`${server}:${serverPort}/api/book_asset/`, {
            ...
            .then((response) => {
                setToastMessage('Asset booked successfully');
            ...
            .catch((error) => {
                ...
                setToastMessage('Error booking asset');
        ...
        <Box>
            ...
            <div className="SAS-Style">
                ...
                <Box className="SAS-switchController">
                    <h2 className="BrasikaFont floatRightIn grayFont">Availability:</h2>
                    <Box className="SAS-switch">
                        <h4 className="BrasikaFont floatRightIn grayFont"> No </h4>
                        {loading ? <p>Loading...</p> :
                            <Switch
                                className="floatRightIn"
                        ...
                        <h4 className="BrasikaFont floatRightIn grayFont"> Yes </h4>
                    </Box>
                </Box>

                {selectedAsset && selectedAsset.availabilityStatus && (
                    <Button variant="outlined" onClick={handleBookAsset}>Book</Button>
                )}
            </div>

            {toastOpen && (
                <div className={`toast ${toastSeverity}`} onClick={handleToastClose}>
                    {toastMessage}
                </div>
            )}
        </Box>
